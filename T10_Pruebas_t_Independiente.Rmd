...
Donde la varianza ponderada (Weighted variance, ${s}^{2}_p$), es un indice de la varianza de los dos grupos tomando en cuenta el tamaño de muestra de cada grupo.  Note que la varianza $s^2$ de cada grupo es multiplicado por (n-1). Por consecuencia un grupo que tiene pocos datos, "n", su varianza tendrá menos peso en los análisis.  
