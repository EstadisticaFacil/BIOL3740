...
ggplot(df)+
  geom_point(data=df, aes(x=Person,y=x),colour="Blue")+
  geom_point(data=df,aes(x=Person,y=y), colour="red")+
  geom_hline(aes(yintercept=mean(df$x)),colour="Blue")+
geom_hline(aes(yintercept=mean(df$y)),colour="red")
