...
#mydat<- read.csv('https://covid.ourworldindata.org/data/latest/owid-covid-latest.csv')

#COVID_19<-read.csv('https://covid.ourworldindata.org/data/owid-covid-data.csv') # Need better wifi
