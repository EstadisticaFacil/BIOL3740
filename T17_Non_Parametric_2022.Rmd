...
```{r posthoc}
#kruskalmc(Sperm~as.factor(SoyaConsumption), data=Soyadf)
library(pgirmess)

kruskalmc(Sperm~Soya, data=Soyadf)
```
...
kwAllPairsNemenyiTest(Sperm~as.factor(Soya) , data=Soyadf, dist="Chisq")
