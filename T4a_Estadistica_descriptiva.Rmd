...
1. con distribución normal
2. con distribución normal, con cola reducida
3. con distribución normal, con cola extendida
...
Ahora se calcula el indice de curtosis y comparamos los valores.  Como regla cuando el nivel de curtosis esta significativo si los valores de curtosis se enuentra en los siguientes rangos, y se acerca cero no hay curtosis (lo que uno espera para una distribución normal.

1. Menor de -1.0 los datos están muy aplanados (Uniforme, normalR).
2. Mayor de 1.0 (la distribución de Laplace)
...
```{r}
library(e1071)
e1071::kurtosis(normal$value) # la oblicuidad de los datos de una distribución normal
e1071::kurtosis(normalR$value) # la oblicuidad de los datos sesgado a la izquierda
e1071::kurtosis(normalE$value) # la oblicuidad de los datos sesgado a la derecha
e1071::kurtosis(Unif$value)
e1071::kurtosis(laplace$value) 
