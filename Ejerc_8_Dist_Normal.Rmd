...
Esta documento tiene algunos ejercicios para evaluar si una distribución es normal
  
  Tema:
  
  - construir un histograma de los datos
  - superponer una distribución teorica sobre el histograma
  - evaluar si los datos tienen una distribución normal usando qqplot
  - evaluar se los datos tienen una distribución noemral usando la prueba de Shaipro_Wilks y Anderson-Darling
