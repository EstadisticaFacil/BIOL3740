...
```{r, ch4, echo=FALSE, fig.cap="El proceso de Investigación", out.width = '60%'}
...
gridExtra::grid.arrange(CIa,CIb, ncol=1)
...
#ggsave("Alturas_Mujer.jpeg") # .png, .tiff, etc
```
