...
## Los supuestos de la regresión logistica.  
  ...
  1. El resultado es la variable es binaria o también conocida como dicótoma (sí o no: presente o ausente, 1 o 0).
  2. Existe una relación lineal entre el logit (p) de la variable de repuesta y las variables predictora.
  3. No hay valores extremos o valores atípicos en los predictores continuos.
  4. No hay correlaciones altas (es decir, multicolinealidad) entre los variables predictores (vea modulo de Correlación).
  


## Comparar modelo lineal y logistico
