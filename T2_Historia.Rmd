...
Así comienza el libro de Salsburg (2001), para describir el comportamiento de los científicos cuando están animados de su tema y el deseo que resolver un enigma. Esa persona con barba de Vandyke era Ronald Aylmer Fisher (1890 -1962) es reconocido como responsable de la *estadística moderna* y una de las personas más importante en el área en el siglo 20. Su contribuciones han tenido un impacto en muchas áreas incluyendo la genética mendeliana y la selección natural.    
...
## Algunos personas importantes
  ...
  1. Trabajo individual: 10 puntos. PARTE de las destrezas que estará aprendiendo en adición de conocer un estadístico es como preparar un documento en .Rmd para hacer una dodumento.  Se someterá tanto el documento en .html y .Rmd en Edmodo.  
    ...
    d. fotos/pintura de la persona
    e. Formulas matemáticas con explicaciones de una de las aportaciones en estadística.
