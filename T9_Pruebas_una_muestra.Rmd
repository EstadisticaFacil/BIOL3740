...
_________
Our hypothesis is that on average people give a tip of $2.50.... This is our **null** hypothesis

Our **alternate** hypothesis is that people give either significantly more or less than $2.50. 
...
```{r t test}
t.test(tips$tip, alternative="two.sided", mu=2.5, conf.level = .70)

```


### How do you graph a the result of a t-test?

Steps

1. Create a normal distribution of the **NULL** hypothesis
2. Calculate the t.test statistics
3. Draw the mean of the t-stattistics on the figure
...
ggplot(data.frame(x=randT))+
  ...
  geom_vline(xintercept = tipTTest$statistic, colour="red")+
