...
$$UL_{0.95}=20+2.093*\left(\frac{1.76}{\sqrt{20}}\right)=20.823$$
...
$$LL_{0.95}=20-2.093*\left(\frac{1.76}{\sqrt{20}}\right)=19.176$$
...
```{r}
UL=20+qt(0.025, 19)*1.76/sqrt(20)
LL=20-qt(0.025, 19)*1.76/sqrt(20)
UL
LL
```
...
abs(qt(0.025, 30))  # valor de t-critico, de la tabla
```
