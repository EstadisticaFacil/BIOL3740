...
|  | NULA, Ho  | ALTERNA, Ha | No es una hipotesis  |
|----|-------:|:---------:|:-------------:|
...
1. El nivel d etipo de error I, o sea el $\alpha$.
2. La differencia entre dos promedios que queremos evaluar.
3. El tamaño de muestra (n).
