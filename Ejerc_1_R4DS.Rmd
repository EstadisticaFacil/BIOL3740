...
1. Leer el capitulo #2, entender lo que quiere decir cada uno de los términos en la figura.  
  Por ejemplo que quiere decir modelos "model" en estadística?
  
  
# Cuarto Paso

1. Abrir un documento nuevo de RMarkdown
2. Quitar/remover lo que no es necesario
3. Seguir los pasos hasta la sección 3.3 del libro **r4ds** y reproducir las gráficas como aparece en el libro y contestar las preguntas y hacer los ejercicios.
